...
namespace FoodNet.Tests.Repository
{
    public class ResultDataServiceTests
    {
        ...
        public void ReturnOnlyTagsCompliant()
        {
            ...
            List<Guid> tagsIds = new List<Guid> { tag1.Id };
        ...
        [Fact]
        public void NoTagsMeansReturnAll()
        {
            var ctx = GetContextWithData();
        ...
        // productCategory 2, user2
        private Product product4;
        private Product product5;
        private Product product6;
        private FridgeProduct fridge2Product4;
        private FridgeProduct fridge2Product5;
        private FridgeProduct fridge2Product6;
        ...
        private Mock<IFridgeRepository> fridgeRepositoryMock;
        ...
        private FoodNetDbContext GetContextWithData()
        {
            ...
            fridge2Product4 = new FridgeProduct
            {
                Id = Guid.NewGuid(),
                FridgeId = fridge2.Id,
                ProductId = product4.Id
            };
            fridge2Product5 = new FridgeProduct
            {
                Id = Guid.NewGuid(),
                FridgeId = fridge2.Id,
                ProductId = product5.Id
            };
            fridge2Product6 = new FridgeProduct
            {
                Id = Guid.NewGuid(),
                FridgeId = fridge2.Id,
                ProductId = product6.Id
            ...
            fridgeRepositoryMock.Setup(fr => fr.GetUserFridge(It.IsAny<Guid>()))
                .Returns<Guid>(userId => ctx.Fridges.Where(f => f.UserId == userId).Single());
